...
int main(void){
   ...
   fprintf(file, "%d-%d-%d %d:%d:%d: Door Monitor Started\n", tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday, tm->tm_hour, tm->tm_min, tm->tm_sec);
   ...
   while(1){
      ...
      fprintf(file, "%d-%d-%d %d:%d:%d: Doorbell has been rung!\n", tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday, tm->tm_hour, tm->tm_min, tm->tm_sec); }
      ...
      if((millis() - switchFilter) > 2000 && filterTrigger == 1){
      filterTrigger = 0;
   ...
   printf("%d-%d-%d %d:%d:%d: PROGRAM QUIT!\n", tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday, tm->tm_hour, tm->tm_min, tm->tm_sec);
