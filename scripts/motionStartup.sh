...
logger -s "Script motionStartup called"
    ...
    TIMESTAMP=$(date +%m_%d_%Y | sed 's/ //g') # No spaces
...
then
	...
	if [  -f /home/pi/routerDrive/$TIMESTAMP ]
	then
    find /home/pi/camera/tmp/. -maxdepth 1 -type f | \
    xargs -I '{}' sudo cp {} /home/pi/routerDrive/$TIMESTAMP/
	sudo cp /home/pi/camera/$TIMESTAMP/log.txt /home/pi/routerDrive/$TIMESTAMP/log.txt
	else
	sudo mkdir /home/pi/routerDrive/$TIMESTAMP/
	sudo chmod 777 /home/pi/routerDrive/$TIMESTAMP/
   find /home/pi/camera/tmp/. -maxdepth 1 -type f | \
   xargs -I '{}' sudo cp {} /home/pi/routerDrive/$TIMESTAMP/
	sudo cp /home/pi/camera/$TIMESTAMP/log.txt /home/pi/routerDrive/$TIMESTAMP/log.txt
	fi
    ...
    sudo cp /home/pi/camera/$TIMESTAMP /home/pi/routerDrive/$TIMESTAMP
